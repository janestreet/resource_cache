...
module type S = sig
  ...
  module Status : Status_intf with type Key.t = key

  type t

  val init : config : Cache_config.t -> common_args -> t
...
module type Cache = sig
  ...
  module type Resource_intf = Resource_intf
  module type S = S
  module type Status_intf = Status_intf
  module Make(R : Resource_intf) : S
